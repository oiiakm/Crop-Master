...
import 'package:cropmaster/features/auth/presentation/pages/otp.dart';
...
class _AuthenticationPageState extends State<AuthenticationPage> {
  ...
  void _validateField(String phoneNumber) {
    if (phoneNumber == '') {
      MessageDisplay.showMessage('Please enter your name and mobile number');
    } else if (phoneNumber == '+91' ||
        phoneNumberController.text.length != 10) {
      MessageDisplay.showMessage('Please enter your 10 digit mobile number');
    } else {
